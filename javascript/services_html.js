const createServiceCategorie = () => {
  ...
  <section class="product">
      ...
      <div class="product-container">
          <div class="product-card">
              <div class="product-image"> <span class="discount-tag">-50% promo</span> <img src="../img/coiffure2.jpg" class="product-thumb" alt=""> <button class="card-btn">Ajouter aux favoris <i class='bx bx-heart bx-tada'></i><button> </div>
  ...
  <section class="product">
      ...
      <div class="product-container">
          <div class="product-card">
              <div class="product-image"> <span class="discount-tag">-50% promo</span> <img src="../img/maquillage2.jpg" class="product-thumb" alt=""> <button class="card-btn">Ajouter aux favoris <i class='bx bx-heart bx-tada'></i><button> </div>
              <div class="product-info">
                  <h2 class="product-brand">Magasin</h2>
                  <p class="product-short-des">Lorem ipsum dolor sit amet..</p> <span class="price">20 €</span> <span class="actual-price">59,99 €</span>
              </div>
